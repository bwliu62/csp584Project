...
@WebServlet("/PostInsuranceReview")
...
public class PostInsuranceReview extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<form method='POST' action='PostInsuranceReview'>");
		...
		pw.println("<input type='hidden' name='insuranceId' value='"+ insuranceId  +  "'></input>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("insuranceId : " + insuranceId + " postId:" + postId);
