...
public class PostHospitalReview extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<form method='POST' action='PostHospitalReview'>");
		...
		pw.println("<input type='hidden' name='hospitalId' value='"+ hospitalId  +  "'></input>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("hospitalId : " + hospitalId + " postId:" + postId);
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss");
		Timestamp timestamp = new Timestamp(System.currentTimeMillis());

		MongoDBDataStoreUtilities.insertHospitalReview(hospitalId, rate, timestamp+"", review);
