    ...
    public static void insertDefaultData() {
        try {
            ...
            conn.prepareStatement(
					...
					+" VALUES (1,2,'Dr. Sue Kafali-Nazarof','gynecologic & cosmetic surgeon','3000 N Halsted St Ste 720, Chicago, IL 60657','41.9367044','-87.6519388','Chicago, IL','09:00:00','17:00:00','2021-08-30'),"
					+" (2,5,'Dr. Ming Li Tsang','Family Medicine','909 Hyde St #432, San Francisco, CA 94109','37.789371','-122.4194441','San Francisco, CA','08:00:00','17:30:00','2021-09-03'),"
					+" (3,9,'Dr. Ryan M Siewert','Family Medicine','1321 W Dakota Pkwy, Williston, ND 58801','48.1559559','-103.6530379','Williston, ND','09:30:00','17:30:00','2021-09-05'),"
					+" (4,7,'Dr. Brynna Connor','Family Medicine','2911 Medical Arts St Building #10, Austin, TX 78705','30.2880745','-97.7295075','Austin, TX','08:00:00','17:30:00','2021-09-05'),"
					+" (5,11,'Dr. Milton Waner','hemangiomas and vascular malformations','210 East 64th Street, 7th Floor, New York City, NY 10065','40.7640723','-73.9655038','New York City, NY','08:15:00','16:30:00','2021-09-06'),"
					+" (6,12,'Dr. David J. Benditzson',' Primary Care','111 N Wabash Ave STE 1412, Chicago, IL 60602','41.8834746','-87.6279434','Chicago, IL','09:30:00','16:30:00','2021-09-12'),"
					+" (7,13,'Dr. Shirish N. Shah',' Cardiology ','5600 W Addison St Ste 400, Chicago, IL 60634','41.9460911','-87.7693311','Chicago, IL','09:00:00','17:30:00','2021-09-12'),"
					+" (8,14,'Dr. Adrian Ma',' Cardiovascular ','5200 Jose Figueres Ave #215, San Jose, CA 95116','37.3615718','-121.8524164','San Jose, CA','08:00:00','15:30:00','2021-09-15'),"
					+" (9,15,'Dr. Russell O. Schub','Gastroenterology','8875 Centre Park Dr suite d, Columbia, MD 21045','39.2289939','-76.8156736','Columbia, MD','10:00:00','16:00:00','2021-09-20'),"
					+" (10,16,'Dr. March E. Seabrook','Gastroenterology','131 Summer Pl Dr, West Columbia, SC 29169','34.0042347','-81.1231826','West Columbia, SC','08:00:00','17:00:00','2021-09-22'),"
					+" (11,17,'Mark W. Galland','Orthopedics','11200 Gov Manly Way #309, Raleigh, NC 27614','35.9477509','-78.543784','Raleigh, NC','09:00:00','17:30:00','2021-09-27'),"
					+" (12,18,'Dr. Jon J. Warner','Orthopedics','55 Fruit St, Boston, MA 02114','42.362706','-71.0708467','Boston, MA','08:30:00','16:30:00','2021-09-28'),"
					+" (13,19,'Dr. Peter Steinberg','Urology','330 Brookline Ave, Boston, MA 02215','42.3398798','-71.106747','Boston, MA','08:30:00','16:30:00','2021-10-08'),"
					+" (14,20,'Dr. Robert Oates','Urology','725 Albany St #3b, Boston, MA 02118','42.3348727','-71.0743435','Boston, MA','09:30:00','18:30:00','2021-10-09'),"
					+" (15,21,'Dr. Edward Zoltan','Urology','175 Remsen St 12th floor, Brooklyn, NY 11201','40.6934999','-73.9935536','Brooklyn, NY','08:30:00','18:00:00','2021-10-11'),"
					+" (16,22,'Dr. Ken Moadel','Ophthalmology','110 E 40th St Floor 6, New York, NY 10016','40.7504117','-73.980187','New York, NY','08:30:00','17:00:00','2021-10-12'),"
					+" (17,23,'Dr. Jacqueline Wong','Ophthalmology','945 Hildebrand Ln NE, Bainbridge Island, WA 98110','47.6336187','-122.5199271','Bainbridge Island, WA','09:00:00','17:00:00','2021-10-15'),"
					+" (18,24,'Dr. John H. Wilkins','Ophthalmology','9155 SW Barnes Rd #430, Portland, OR 97225','45.510411','-122.772308','Portland, OR','09:00:00','14:00:00','2021-10-16'),"
					+" (19,27,'Dr. Nayantara Seneviratne','Endocrinologists','2250 Hayes St Ste. 612, San Francisco, CA 94117','37.7731512','-122.4556097','San Francisco, CA','08:30:00','16:00:00','2021-10-18'),"
					+" (20,26,'Jennifer N. Ouchi','Endocrinologists','8635 W 3rd St, Los Angeles, CA 90048','34.0739596','-118.3831086','Los Angeles, CA','08:30:00','16:00:00','2021-10-19'),"
					+" (21,25,'Erin McCann','Endocrinologists','1658 N Milwaukee Ave, Chicago, IL 60647','41.911521','-87.6820203','Chicago, IL','09:30:00','16:00:00','2021-10-19'),"
					+" (22,28,'Dr. Chienying Liu, MD','Endocrinologists','400 Parnassus Ave Suite A-550, San Francisco, CA 94143','37.7645542','-122.4594448','San Francisco, CA','09:30:00','17:00:00','2021-10-20'),"
					+" (23,29,'Dr. Sujani G. Surakanti, MD','Hematologists','1 Gustave L. Levy Pl, New York, NY 10029','40.7900079','-73.9559261','New York, NY ','09:30:00','16:15:00','2021-10-21'),"
					+" (24,30,'Elizondo Joseph MD','Internists','6835 Austin Center Blvd, Austin, TX 78731','30.3512728','-97.752607','Austin, TX','10:00:00','16:00:00','2021-10-21'),"
					+" (25,31,'Dr. Mark S. Rosen, MD','Nephrologists','3000 N Interstate 35 Frontage Rd, Austin, TX 78705','30.2884636','-97.7264813','Austin, TX','08:30:00','15:00:00','2021-10-22'),"
					+" (26,32,'Ayman Layka, MD','Nephrologists','4302 Alton Rd #400, Miami Beach, FL 33140','25.8140468','-80.1418685','Miami Beach, FL','09:30:00','15:00:00','2021-10-24'),"
					+" (27,33,'Wohlfeiler Michael MD','Internists','4308 Alton Rd, Miami Beach, FL 33140','25.8148808','-80.1426972','Miami Beach, FL','08:30:00','16:00:00','2021-10-25'),"
					+" (28,34,'Dr. Gerald H. Watanabe, MD','Internists','321 N Kuakini St STE 802, Honolulu, HI 96817','21.3215492','-157.858117','Honolulu, HI','09:30:00','17:00:00','2021-10-26'),"
					+" (29,35,'Dr. Kore Liow MD','Neurologists','1329 Lusitana St #307, Honolulu, HI 96813','21.3076091','-157.8542824','Kailua, HI','08:00:00','17:00:00','2021-10-27'),"
					+" (30,36,'Cho Jonathan MD','Oncologists','9155 SW Barnes Rd #430, Portland, OR 97225','45.510411','-122.7723133','Portland, OR','08:30:00','17:30:00','2021-10-28');")
                    .execute();
				...
				conn.prepareStatement(
					...
					+" VALUES (1,61,'Chicago Pediatric and Neonatology','7447 W Talcott Ave # 561, Chicago, IL 60631','41.9876675','-87.8145514','Chicago, IL','09:00:00','17:00:00','2021-08-30'),"
					+" (2,62,'Donohoe Pediatrics','3916 N Damen Ave., Chicago, IL 60618','41.9529772','-87.6790409','Chicago, IL','08:00:00','17:30:00','2021-09-03'),"
					+" (3,63,'MIRACLE MILE PEDIATRICS','6221 Wilshire Blvd #215, Los Angeles, CA 90048','34.063501','-118.3640248','Los Angeles, CA','09:30:00','17:30:00','2021-09-05'),"
					+" (4,64,'San Francisco Medical Center and Medical Offices','2238 Geary Blvd 7th floor, San Francisco, CA 94115','37.7833688','-122.4406775','San Francisco, CA','08:00:00','17:30:00','2021-09-05'),"
					+" (5,65,'Brooklyn Hospital Center-Hematology','121 Dekalb Ave, Brooklyn, NY 11201','40.7240049','-73.9789535','Brooklyn, NY','08:15:00','16:30:00','2021-09-06'),"
					+" (6,66,'Lenox Hill Hospital','100 E 77th St, New York, NY 10075','40.691265','-73.9777743','New York, NY','09:30:00','16:30:00','2021-09-12'),"
					+" (7,67,'Mount Sinai Kravis Childrens Hospital','1184 5th Ave, New York, NY 10029','40.7900579','-73.9538592','New York, NY','09:00:00','17:30:00','2021-09-12'),"
					+" (8,68,'St. David`s South Austin Medical Center','901 W Ben White Blvd, Austin, TX 78704','30.2261149','-97.7745674','Austin, TX','08:00:00','15:30:00','2021-09-15'),"
					+" (9,69,'Baylor Scott & White Medical Center','5245 W US Hwy 290 Service Rd, Austin, TX 78735','30.2358362','-97.8344989','Austin, TX','10:00:00','16:00:00','2021-09-20'),"
					+" (10,70,'Shoal Creek Hospital','3529 Mills Ave, Austin, TX 78731','30.3059555','-97.7484764','Austin, TX','08:00:00','17:00:00','2021-09-22'),"
					+" (11,71,'Orlando Health Arnold Palmer Hospital for Children','92 W Miller St, Orlando, FL 32806','28.4590107','-81.4968755','Orlando, FL','09:00:00','17:30:00','2021-09-27'),"
					+" (12,72,'Orlando Health Heart & Vascular Institute','1222 S Orange Ave, Orlando, FL 32806','28.5233918','-81.3800672','Orlando, FL','08:30:00','16:30:00','2021-09-28'),"
					+" (13,73,'South Miami Hospital','6200 SW 73rd St, Miami, FL 33143','25.7029961','-80.2943575','Miami, FL','08:30:00','16:30:00','2021-10-08'),"
					+" (14,74,'Mercy Hospital','3663 S Miami Ave, Miami, FL 33133','25.7400049','-80.213526','Miami, FL','09:30:00','18:30:00','2021-10-09'),"
					+" (15,75,'Hawaii Cancer Care','1329 Lusitana St #307, Honolulu, HI 96813','21.3076091','-157.8520883','Honolulu, HI','08:30:00','18:00:00','2021-10-11'),"
					+" (16,76,'Straub Outpatient Treatment Center','888 S King St, Honolulu, HI 96813','21.3025814','-157.8501322','Honolulu, HI','08:30:00','17:00:00','2021-10-12'),"
					+" (17,77,'Howard County General Hospital','5755 Cedar Ln, Columbia, MD 21044','39.2141113','-76.885968','Columbia, MD','09:00:00','17:00:00','2021-10-15'),"
					+" (18,78,'Oncology/Hematology California Pacific Medical Center','2238 Geary Blvd 7th floor, San Francisco, CA 94115','37.7833688','-122.4406775','San Francisco, CA','09:00:00','14:00:00','2021-10-16'),"
					+" (19,79,'Pali Momi Medical Center','98-1079 Moanalua Rd, Aiea, HI 96701','21.3835987','-157.9382973','Aiea, HI','08:30:00','16:00:00','2021-10-18'),"
					+" (20,80,'Duke Raleigh Hospital','3400 Wake Forest Rd, Raleigh, NC 27609','35.8284188','-78.6183679','Raleigh, NC','08:30:00','16:00:00','2021-10-19'),"
					+" (21,81,'WakeMed North Hospital','10000 Falls of Neuse Rd, Raleigh, NC 27614','35.9091252','-78.5977337','Raleigh, NC','09:30:00','16:00:00','2021-10-19'),"
					+" (22,82,'Holly Hill Hospital','3019 Falstaff Rd, Raleigh, NC 27610','35.782772','-78.5839164','Raleigh, NC','09:30:00','17:00:00','2021-10-20'),"
					+" (23,83,'Lexington Medical Center','2720 Sunset Blvd, West Columbia, SC 29169','34.0068841','-81.1137621','West Columbia, SC','09:30:00','16:15:00','2021-10-21'),"
					+" (24,84,'St. Michael Medical Center','2520 Cherry Ave, Bremerton, WA 98310','47.5829409','-122.6251543','Bainbridge Island, WA','10:00:00','16:00:00','2021-10-21'),"
					+" (25,85,'Swedish Primary Care','945 Hildebrand Ln NE Suite 100, Bainbridge Island, WA 98110','47.6336543','-122.5177735','Bainbridge Island, WA','08:30:00','15:00:00','2021-10-22'),"
					+" (26,86,'Virginia Mason Hospital and Seattle Medical Center','1100 9th Ave, Seattle, WA 98101','47.6094886','-122.327968','Bainbridge Island, WA','09:30:00','15:00:00','2021-10-24'),"
					+" (27,87,'OHSU Hospital','3181 SW Sam Jackson Park Rd, Portland, OR 97239','45.4980686','-122.6850168','Portland, OR','08:30:00','16:00:00','2021-10-25'),"
					+" (28,88,'Vibra Specialty Hospital of Portland','10300 NE Hancock St, Portland, OR 97220','45.5356684','-122.5565101','Portland, OR','09:30:00','17:00:00','2021-10-26'),"
					+" (29,89,'Providence Portland Medical Center','4805 NE Glisan St, Portland, OR 97213','45.5281789','-122.6119391','Portland, OR','08:00:00','17:00:00','2021-10-27'),"
					+" (30,90,'Legacy Emanuel Medical Center','2801 N Gantenbein Ave, Portland, OR 97227','45.5436861','-122.6695411','Portland, OR','08:30:00','17:30:00','2021-10-28');")
					.execute();
				...
				conn.prepareStatement(
					...
					+" VALUES (1,91,'Cost-U-Less Insurance','1152 N Capitol Ave, San Jose, CA 95132','37.3879017','-121.8599859','San Jose, CA','09:00:00','17:00:00','2021-08-30'),"
					+" (2,92,'L V Insurance','1625 Flickinger Ave, San Jose, CA 95131','37.3901792','-121.8791306','San Jose, CA','08:00:00','17:30:00','2021-09-03'),"
					+" (3,93,'Fred Loya Insurance','154 S Jackson Ave, San Jose, CA 95116','37.3563654','-121.840821','San Jose, CA','09:30:00','17:30:00','2021-09-05'),"
					+" (4,94,'Texas Mutual Insurance Company','2200 Aldrich St, Austin, TX 78723','30.3010368','-97.7035713','Austin, TX','08:00:00','17:30:00','2021-09-05'),"
					+" (5,95,'Texas Life Insurance Co','229 Parkhill St, Huntsville, TX 77340','30.7061257','-95.5336161','Huntsville, TX','08:15:00','16:30:00','2021-09-06'),"
					+" (6,96,'Texas Insurance Place','4101 W Green Oaks Blvd ste 305-105, Arlington, TX 76016','32.6820499','-97.1948966','Arlington, TX','09:30:00','16:30:00','2021-09-12'),"
					+" (7,97,'Island Insurance Hawaii','1022 Bethel St, Honolulu, HI 96813','21.3101916','-157.8623647','Honolulu, HI','09:00:00','17:30:00','2021-09-12'),"
					+" (8,98,'First Insurance Company of Hawaii, LTD','1100 Ward Ave, Honolulu, HI 96814','21.3035122','-157.8498528','Honolulu, HI','08:00:00','15:30:00','2021-09-15'),"
					+" (9,99,'Farmers Insurance Hawaii','Six Waterfront Plaza, 500 Ala Moana Blvd 5th Floor, Honolulu, HI 96813','21.3018247','-157.8619678','Honolulu, HI','10:00:00','16:00:00','2021-09-20'),"
					+" (10,100,'Insurance Company of Florida','3751 Maryweather Ln #102, Wesley Chapel, FL 33544','28.2118594','-82.356133','Wesley Chapel, FL','08:00:00','17:00:00','2021-09-22'),"
					+" (11,101,'Great Florida Insurance','11362 Orange Blossom Trail, Orlando, FL 32837','28.400058','-81.4060582','Orlando, FL','09:00:00','17:30:00','2021-09-27'),"
					+" (12,102,'Florida Peninsula Insurance Company','903 NW 65th St, Boca Raton, FL 33487','26.406303','-80.1047321','Boca Raton, FL','08:30:00','16:30:00','2021-09-28'),"
					+" (13,103,'Florida Family Insurance Co','27599 Riverview Center Blvd # 100, Bonita Springs, FL 34134','26.3397713','-81.8087294','Bonita Springs, FL','08:30:00','16:30:00','2021-10-08'),"
					+" (14,104,'Westside Portland Insurance Company','1615 SE, SE Tualatin Valley Hwy STE.1, Hillsboro, OR 97123','45.5092931','-122.9661441','Hillsboro, OR','09:30:00','18:30:00','2021-10-09'),"
					+" (15,105,'Timmco Insurance, Inc.','1615 NE Broadway, Portland, OR 97232','45.5352682','-122.6490668','Portland, OR','08:30:00','18:00:00','2021-10-11'),"
					+" (16,106,'Chet Hill Insurance','10402 NE Sandy Blvd, Portland, OR 97220','45.5587471','-122.5555748','Portland, OR','08:30:00','17:00:00','2021-10-12'),"
					+" (17,107,'Vern Fonk Insurance','9955 SE Washington St Ste 103, Portland, OR 97216','45.5186054','-122.560982','Portland, OR','09:00:00','17:00:00','2021-10-15'),"
					+" (18,108,'WelPland Insurance','5845 SE 82nd Ave, Portland, OR 97266','45.4802632','-122.5792714','Portland, OR','09:00:00','14:00:00','2021-10-16'),"
					+" (19,109,'Guardian Life Insurance Company of America','3435 Wilshire Blvd Suite 1550, Los Angeles, CA 90010','34.0622654','-118.2984956','Los Angeles, CA ','08:30:00','16:00:00','2021-10-18'),"
					+" (20,110,'Public Insurance Agency','10941 W Pico Blvd, Los Angeles, CA 90064','34.039236','-118.431037','Los Angeles, CA','08:30:00','16:00:00','2021-10-19'),"
					+" (21,111,'Greater New York Insurance Co','200 Madison Ave #3, New York, NY 10016','40.749138','-73.9825933','New York, NY','09:30:00','16:00:00','2021-10-19'),"
					+" (22,112,'New York Life Insurance Company','1 MetroTech Center 17th floor, Brooklyn, NY 11201','40.6932748','-73.9866898','Brooklyn, NY','09:30:00','17:00:00','2021-10-20'),"
					+" (23,113,'Rizzo Insurance Group, Inc.','310 Broadway, Revere, MA 02151','42.4089016','-71.0136072','Revere, MA','09:30:00','16:15:00','2021-10-21'),"
					+" (24,114,'Boston Mutual Life Insurance Company','120 Royall St, Canton, MA 02021','42.204151','-71.1291713','Canton, MA','10:00:00','16:00:00','2021-10-21'),"
					+" (25,115,'John Hancock Life Insurance Co','200 Berkeley St #1, Boston, MA 02116','42.3498585','-71.0727563','Boston, MA','08:30:00','15:00:00','2021-10-22'),"
					+" (26,116,'Lordea Home Insurance','290 Bennington St, Boston, MA 02128','42.378997','-71.0285815','Boston, MA','09:30:00','15:00:00','2021-10-24'),"
					+" (27,117,'Point Insurance','1103 Commonwealth Avenue, Boston, MA 02215','42.3519424','-71.1254774','Boston, MA','08:30:00','16:00:00','2021-10-25'),"
					+" (28,118,'Winmore Insurance Solutions LLC.','4152 W Armitage Ave, Chicago, IL 60639','41.917378','-87.731106','Chicago, IL','09:30:00','17:00:00','2021-10-26'),"
					+" (29,119,'Pro Insurance Group','2521 Technology Dr Suite 201, Elgin, IL 60124','42.0898523','-88.3392642','Elgin, IL','08:00:00','17:00:00','2021-10-27'),"
					+" (30,120,'Eagle Insurance','2433 W 79th St, Chicago, IL 60652','41.7498883','-87.6842339','Chicago, IL','08:30:00','17:30:00','2021-10-28');")
                    .execute();


            conn.prepareStatement("INSERT INTO Appointment (providerId, customerId, appointmentDate, appointmentTime)"
                    + "VALUES (2,1,'2021-10-20','2021-10-20 10:00:00')," + "(2,10,'2021-10-07','2021-10-07 15:00:00'),"
                    + "(5,3,'2021-10-31','2021-10-31 09:30:00')," + "(5,3,'2021-11-01','2021-11-01 13:45:00'),"
                    + "(5,6,'2021-10-31','2021-10-31 09:30:00')," + "(5,2,'2021-11-01','2021-11-01 13:45:00'),"
                    + "(5,3,'2021-10-31','2021-10-31 09:30:00')," + "(5,6,'2021-11-01','2021-11-01 13:45:00'),"
                    + "(2,3,'2021-11-20','2021-11-20 10:00:00')," + "(7,8,'2021-10-15','2021-10-15 10:15:00'),"
                    + "(7,6,'2021-11-20','2021-11-20 10:30:00')," + "(5,10,'2021-10-06','2021-10-06 09:20:00'),"
                    + "(5,10,'2021-11-06','2021-11-06 14:30:00')," + "(5,8,'2021-10-30','2021-10-30 09:20:00');")
                    .execute();
