...
public class PostDoctor extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<form method='post' action='DoctorList'>");
		...
		pw.println("<input type='hidden' name='doctorId' value='"+ user.getId() +"'></input>");
		pw.println("<input type='submit' class='btnbuy' name='doctor' value='Create'style='float: right;height: 20px margin: 20px; margin-right: 10px;'></input>");
