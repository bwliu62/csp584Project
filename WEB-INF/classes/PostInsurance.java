...
public class PostInsurance extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<input type='hidden' name='insuranceId' value='"+ user.getId() +"'></input>");
		pw.println("<input type='submit' class='btnbuy' name='insurance' value='Create'style='float: right;height: 20px margin: 20px; margin-right: 10px;'></input>");
